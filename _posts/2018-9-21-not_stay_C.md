...
After graduating form my undergraduate school, I never trying to apply any of C graduate university. There is nothing that I can not learn with my fairly good E and the ability to break though the stupid Great Wall. Although my physical body is in C, I study with MIT, google engineers and EA engineers, communicate with rest of the world and rarely use C.


### technology

Almost all the essential technologies you are using everyday are developed by A. Think about the processors, the electricity ,the operating systems, the computer networking you are using everyday and the on going AI which would change the world dramatically. There are numerous things I can not list. You should appreciate about that.
...
I am a person trending to let something best more better but not repair or upgrade something poorly designed. If the processor are slow or memory is too low, I discard the phone directly and buy a brand new one. If my native L is not so competent I change a new one no matter how timing consuming it is to studying a new language(If you are serious, it can take up to two years before the language come to a useful level). 
